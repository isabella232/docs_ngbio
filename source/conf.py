# -*- coding: utf-8 -*-
#
# Документация NextGIS Bio documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('docs_ngbio'))
sys.path.insert(1, os.path.abspath('docs_ngbio/source'))
...
project = u'Документация NextGIS Bio'
copyright = u'2015, NextGIS'
author = u'Илья Филипов, Иван Ковалев'
...
man_pages = [
    (master_doc, 'nextgisbio', u'Документация NextGIS Bio',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'NextGISBio', u'Документация NextGIS Bio',
   author, 'NextGISBio', 'One line description of project.',
   'Miscellaneous'),
]
